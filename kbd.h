...
// и вторым нажатием кнопки дл€ двойного щелчка
...
#define BUT_COUNT_HELD       150
//=============================================================================
// размер буфера событий.
// ≈го значение должно быть 
...
//=============================================================================
#define BUT_1_ID     1
#define BUT_1_DDRX   DDR(BUT_PLUS)
#define BUT_1_PORTX  PORT(BUT_PLUS)
#define BUT_1_PINX   PIN(BUT_PLUS)
#define BUT_1_PIN    BUT_PLUS_PIN
#define BUT_1_LEV    0
#define BUT_1_PULL   1
#define BUT_1_EVENT  (BUT_EV_ALL)

#define BUT_2_ID     2
#define BUT_2_DDRX   DDR(BUT_SET)
#define BUT_2_PORTX  PORT(BUT_SET)
#define BUT_2_PINX   PIN(BUT_SET)
#define BUT_2_PIN    BUT_SET_PIN
#define BUT_2_LEV    0
#define BUT_2_PULL   1
#define BUT_2_EVENT  (BUT_EV_ALL)

#define BUT_3_ID     3
#define BUT_3_DDRX   DDR(BUT_MINUS)
#define BUT_3_PORTX  PORT(BUT_MINUS)
#define BUT_3_PINX   PIN(BUT_MINUS)
#define BUT_3_PIN    BUT_MINUS_PIN
#define BUT_3_LEV    0
#define BUT_3_PULL   1
#define BUT_3_EVENT  (BUT_EV_ALL)
//=============================================================================
// инициализаци€. вызываетс€ в начале программы
void KBD_init(void);
// опрос кнопок/входов. вызываетс€ периодически
void KBD_poll(void);
